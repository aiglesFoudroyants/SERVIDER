        ...
        <div class="wrap">
            ...
            <section id="main">
                ...
                <div class="content margin-top60 margin-bottom60">
                    <div class="row">
                        <div class="col-md-8 col-md-push-2" style="background-color:greenyellow;">
                            <div class="col-md-4" style="background-color:purple;padding:10px;align-items: center;display: flex;">
                            ...
                            <div class="col-md-4" style="background-color:green;padding:10px;align-items: center;display: flex;">
                                <div class="col-md-5" style="text-align: center">
                                    Disponible :
                                </div>
                                <div class="col-md-7">
                            ...
                            <div class="col-md-4" style="background-color:blue;padding:10px;padding-left:25px;padding-right:25px;align-items: center;display: flex;">
